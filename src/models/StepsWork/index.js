    ...
    cards: [
        {
            ...
            description: 'Какой то будет большой текст, не понятно, что писать, но что нибудь напишем.',
            icon: garden_house_icon
        },
        {
            id: 2,
            title: 'Мы отправляем в нашу автоматизированную базу данных',
            description: 'Какой то будет большой текст, не понятно, что писать, но что нибудь напишем.',
        ...
        {
            id: 4,
            title: 'Проводим видеоконференцию с понравившимся кандидатом',
            description: 'Какой то будет большой текст, не понятно, что писать, но что нибудь напишем.',
            icon: shopping_icon },
        {
            id: 5,
        ...
        {
            id: 6,
            title: 'Месяц гарантии с заменой',
            description: 'Какой то будет большой текст, не понятно, что писать, но что нибудь напишем.',
            icon: minor_repairs_icon
        },
    ]
}
