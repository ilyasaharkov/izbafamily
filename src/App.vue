<template>
  <div class="app">
    ...
    <Form
        ...
        subtitle="Поможем сделать все то, что самостоятельно не всегда возможно.<br>
        Оставьте заявку на консультацию или звоните нам по телефону: <strong><a href='tel:79802099410'>+7(980)209-94-10</a></strong>"
    />
    <CheckingCouples />
    <StepsWork />
